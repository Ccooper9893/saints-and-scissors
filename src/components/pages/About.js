...
export default function About() {
    return (
        <div className='w-full bg-black pt-24 md:pt-32'>
            <div className='flex flex-col justify-center lg:w-2/5 mx-3 lg:mx-auto text-center'>
            ...
            <div className='relative w-full md:w-1/4 mt-5 lg:mt-6 mx-auto' id="about">
                <img className='opacity-80' src={aboutBg} alt='Grunge style grafitied women with beatiful hair'></img>
