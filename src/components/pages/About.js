    ...
    <div id='about' className='h-full bg-stone-950 text-stone-300'>
      <div className='pt-4 py-12'>
        <div className='flex flex-col justify-center lg:w-2/3 mt-6 lg:mx-auto text-center'>
          <h2 className='font2 text-6xl lg:text-8xl center text-stone-200 pb-4 md:mb-24z-10'>
            Unlock <br />
            Your Hair's< br />
          ...
          <div className='flex flex-col md:flex-row'>
            <div className='relative px-8 lg:mt-6 mt-10 w-full'>
              <Parallax speed={-5}>
                <img className='opacity-80 mx-auto z-0 bg-stone-300 rotate-2' src={aboutBg} alt='Grunge style women'></img>
              </Parallax>
            ...
            <div className='py-6 md:my-auto bg-stone-900 shadow-inner shadow-black z-10'>
              <p className='text-xl p-4 tracking-wide md:text-left'>At <span className='font4'>Saints and Scissors,</span><br />we are more than just hairstylists - we are <strong>artists</strong>, <strong>creators</strong>, and <strong>visionaries</strong> dedicated to transforming your hair into a work of art. With a passion for perfection and an unwavering commitment to making you look and feel your best, we have become a go-to destination for exceptional hair design and care.</p>
      ...
      <div className='w-4/5 py-4 mx-auto bg-stone-600 z-0'>
        <Rating />
      </div>
      <hr className='w-4/5 lg:w-5/6 mx-auto my-6 md:my-24 opacity-40'></hr>
    </div>
  )
}