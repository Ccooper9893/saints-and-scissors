...
export default function About({navAboutRef}) {
    return (
        ...
        <div className='pt-4'>
          ...
          <Parallax speed={-8}>
            <img className='opacity-80 mx-auto z-0' src={aboutBg} alt='Grunge style women' ref={navAboutRef}></img>
            </Parallax>
