...
export default function About({ navAboutRef }) {
  return (
    <div id='about' className='h-full bg-stone-200 text-stone-950'>
      <div className=''>
        <div className='flex flex-col justify-center lg:w-3/4 mt-6 lg:mx-auto text-center'>
          <div className='border-t border-stone-900'>
          <h2 className='font2 text-6xl lg:text-9xl center text-stone-950 mx-4 mt-5 py-4 md:mb-24 z-10'>
            Unlock
            Your Hair's< br />
          ...
          <div className='flex flex-col'>
            <div className='relative px-8 w-full'>
              <Parallax speed={-4}>
                <img className='mx-auto z-0 border-b border-stone-900 rotate-2' src={aboutBg} alt='Grunge style women'></img>
              </Parallax>
