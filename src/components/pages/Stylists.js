...
export default function Stylists({ toggleBooking, navStylistsRef }) {
    return (
        <div id='stylists' className=''>
            <div ref={navStylistsRef}>
                <div className="md:w-4/5 mx-auto py-16">
                    <div className='flex-row flex-wrap'>
                        <img className='mx-auto md:mx-24 h-10 -rotate-12 my-6' src={scissors}></img>
                        <h2 className='text-stone-900 text-center md:text-left font2 text-4xl md:text-5xl px-4 md:px-12 uppercase'>MEET THE SAINTS <br />BEHIND THE SCISSORS</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-x-4 gap-y-4 md:gap-y-12 px-8 py-12">
                        ...
                        <div className='text-left text-stone-950 my-4'>
