    ...
    return (
        <div id='home'>
            ...
            <motion.button
                ...
                className='fixed right-1/4 bottom-8 tracking-widest z-10 w-1/2 py-2 rounded-sm text-black text-center text-sm bg-lime-400 bg-opacity-70 shadow-lg shadow-black hover:shadow-none'>
                BOOK NOW
            </motion.button>
