    ...
    return (
        <div id='home'>
            ...
            <motion.img
                ...
                whileInView={{ opacity: 1, y: 20 }}
                transition={{ ease: "easeOut", duration: 1, delay: .5 }}
                className='fixed top-1/4 z4 md:w-1/3 md:right-1/3'
                src={titleAndLogo}
                alt='Saints and Scissors Logo'>
            </motion.img>
            {/* <motion.p
            ...
            {/* <motion.button
                ...
                className='fixed top-3/4 right-1/4 md:right-24 tracking-widest z-10 w-1/2 md:w-1/5 py-1 md:py-1 border border-lime-500 text-lime-400'>
                BOOK NOW
            </motion.button> */}
                        {/* <motion.button
                initial={{ opacity: 0, x: 0 }}
