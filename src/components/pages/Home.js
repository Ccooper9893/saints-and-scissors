    ...
    return (
        <div id='home'>
            ...
            <motion.button
                ...
                className='fixed right-1/4 md:right-6 bottom-6 md:bottom-4 tracking-widest z-10 w-1/2 md:w-1/4 py-1 md:py-3 font-extrabold bg-lime-500 text-stone-950 shadow-lg shadow-stone-950'>
                BOOK NOW
            </motion.button>
