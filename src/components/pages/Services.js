...
export default function Services({ toggleBooking, navServicesRef }) {
    return (
        <div id='services' className=' bg-stone-100 shadow shadow-stone-900'>
            <div ref={navServicesRef}>
                <div className='flex flex-col lg:flex-row mt-12 md:py-24'>
                    ...
                    <div className='mt-6 md:mt-28 md:mx-2 md:w-3/5 text-center'>
                        <h2 className='text-stone-900 font2 py-4 text-5xl md:text-5xl mx-4 md:px-16 uppercase'>Tailored Services for Your <span className='text-violet-600 font2'>Unique</span> Style</h2>
                        
                        <p className='text-xl md:right md:mx-auto p-2 tracking-wide text-stone-700'>Whether you're seeking a fresh, on-trend haircut, a bold and vibrant color transformation, or a classic, timeless look, our team is dedicated to creating a personalized, unparalleled experience that leaves you feeling confident, beautiful, and absolutely unique. We offer a wide range of services to cater to your unique preferences and needs.</p>
