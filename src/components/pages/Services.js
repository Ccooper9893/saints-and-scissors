            ...
            <div ref={navServicesRef}>
                <div className='flex flex-col justify-center'>
                    ...
                    <div className='md:mx-auto md:w-3/5 py-12 text-center z-40'>
                        {/* <h2 className='text-stone-200 font2 py-8 text-5xl md:text-6xl mx-4 md:px-16 uppercase'>Tailored<br /> Services for Your <br /><em className='text-violet-500 font2'>Unique </em>Style.</h2> */}                        <img className='mx-auto h-10 -rotate-12 my-8' src={scissors} alt='scissors icon'></img>
