            ...
            <div ref={navContactRef}>
                ...
                <div className="flex flex-col w-full md:w-3/4 mx-auto md:px-16 py-10">
                    <div className="md:full ">
                        <div className="w-full md:w-full text-center px-3 ">
                            ...
                            <div className="flex flex-col md:flex-row md:w-full mx-auto justify-around bg-stone-200 p-2 my-6 shadow-inner shadow-black">
                                ...
                                <div className="p-6 text-black">
                                    ...
                                    <h4 className="text-xl md:text-2xl font-bold">Contact</h4>
                                    <hr className='opacity-20'></hr>
                                    <ul className="text-md">
                                        <li>Phone: <a href="tel:4809462322" className=" hover:underline"><span className="font-bold">(480) 946-2322</span></a></li>
                                        <li>Email: <a href="mailto:saintsandscissors1@gmail.com" className=" hover:underline"><span className="font-bold">saintsandscissors1@gmail.com</span></a></li>
                                ...
                                <div className="text-black">
                                    ...
                                    <h4 className="text-xl md:text-2xl font-bold">Hours of Operation</h4>
                                    <hr className='opacity-20'></hr>
                                    <ul className="text-md">
                                ...
                                <div className="w-full md:w-1/2 border border-stone-500 h-3/4 mx-auto my-10">
                                    <iframe
