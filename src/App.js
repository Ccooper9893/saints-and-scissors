...
import aboutBg from './assets/backgrounds/slides-home-4.jpg';
        ...
        <div className="carousel-item backgroundAbout" id='about'>
          <div className='h-full w-full bg-black pt-20 md:pt-14'>
            <div className='flex flex-col justify-center lg:w-3/5 mt-6 mx-3 lg:mx-auto text-center'>
              ...
              <hr className='w-4/5 lg:w-3/4 mx-auto mt-2 mb-4'></hr>
              ...
              <div className='flex flex-row align-middle justify-center my-2 text-center '>
                <div>
                  <Rating />
                  <small><em>- Google</em></small>
                </div>
                <div>
                  <Rating />
                  <small><em>- Yelp</em></small>
                </div>
                <div>
                  <Rating />
                  <small><em>- Facebook</em></small>
                </div>
              </div>
            </div>
            <div className='relative w-full md:w-1/3 mt-12 lg:mt-6 mx-auto'>
              <img class='border border-x-8 border-black' src={aboutBg} alt='Inside of Saints and Scissors salon. Couch and multiple barber chairs. Coloristic interior design with an emphasize on a lime green, punk rock style.'></img>
